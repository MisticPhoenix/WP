...
<header class="header">
    <div class="container">
        ...
        <div class="header__content">
            ...
            <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('PhotoInHeader');?>"
                 alt="ford mustang">
        </div>
    </div>
</header>